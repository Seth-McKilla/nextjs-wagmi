...
import {DAOProposal} from "../src/DAOProposal.sol";

contract DeployDAO is Script {
    uint256 public constant _quorum = 1;

    uint256 public constant _votingDuration = 10;
    ...
    function run() external {
        ...
        DAOProposal dao = new DAOProposal{salt: SALT}(_quorum, _votingDuration);
